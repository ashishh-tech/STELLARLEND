    ...
    <nav className="fixed top-0 left-0 w-full z-50 px-4 md:px-6 py-3.5 bg-navy-950/80 backdrop-blur-2xl border-b border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all">
      <div className="container mx-auto flex justify-between items-center w-full max-w-6xl">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <Logo size="md" />
          <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-brand-emerald/10 border border-brand-emerald/25 rounded-full text-xs font-mono text-brand-emerald">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          {/* Quick Links / Modals */}
          <div className="flex items-center gap-2 font-headline text-xs font-semibold">
            {onOpenOnboarding && (
              <button
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden lg:flex items-center gap-1 text-slate-400 hover:text-white transition-colors text-xs font-mono px-2 py-1.5"
            >
              <span>Contract</span>
